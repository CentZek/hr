    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50\" onClick={onClose}>
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4 overflow-hidden" onClick={e => e.stopPropagation()}>
        <div className="bg-green-600 p-4 flex items-center">
          ...
          <h3 className="text-xl font-semibold text-white">Confirm Approve All</h3>
        ...
        <div className="p-6">
          <div className="bg-green-50 border border-green-100 rounded-md p-4 mb-4 flex items-start">
            ...
            <div className="text-base text-green-800 font-medium">
              <p className="font-semibold mb-1">You are about to approve all records</p>
          ...
          <div className="flex justify-end space-x-3">
            <button
              onClick={onClose}
              className="px-4 py-2 border border-gray-300 rounded-md shadow-sm text-base font-semibold text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
            ...
            <button
              onClick={onConfirm}
              disabled={isProcessing}
              className="px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-semibold text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isProcessing ? 
