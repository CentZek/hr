        ...
        <div className="p-6">
          <div className="bg-red-50 border border-red-100 rounded-md p-4 mb-4 flex items-start">
            ...
            <div className="text-base text-red-800 font-medium">
              ...
              <p>{message}</p>
              {scope === "all" && <p className="mt-2 font-semibold">All time records for all employees will be permanently deleted.</p>}
              {scope === "month" && <p className="mt-2 font-semibold">All time records for the selected month will be permanently deleted.</p>}
            </div>
          </div>
          
          <div className="text-base text-gray-700 font-medium mb-4">Please type <strong>DELETE</strong> to confirm:</div>
          
          <input
            type="text"
            className="w-full border border-gray-300 rounded-md px-3 py-2 mb-4 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-base"
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              disabled={isDeleting}
              className="px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-semibold text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isDeleting ? 
